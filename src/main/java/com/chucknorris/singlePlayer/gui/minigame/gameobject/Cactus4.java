...
public class Cactus4 extends Enemy {
	
	public static final int Y_LAND = 725;
	...
	public Cactus4(MainCharacter4 mainCharacter, int posX, int width, int height, BufferedImage image) {
		this.posX = posX;
		this.width = width;
		this.height = height;
		this.image = image;
