...
public class Land3 {
	...
	public static final int LAND_POSY = 503;
	...
	public Land3(int width, MainCharacter3 mainCharacter) {
		this.mainCharacter = mainCharacter;
		land1 = Resource.getResouceImage("data/jugador3/land1.png");
		land2 = Resource.getResouceImage("data/jugador3/land2.png");
		land3 = Resource.getResouceImage("data/jugador3/land3.png");
