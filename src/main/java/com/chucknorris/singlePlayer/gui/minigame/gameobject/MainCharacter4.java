...
import com.chucknorris.singlePlayer.gui.minigame.util.Animation;
import com.chucknorris.singlePlayer.gui.minigame.util.Resource;

public class MainCharacter4 {

	private static final int LAND_POSY = 680;
	...
	public MainCharacter4() {
		posX = 50;
		posY = LAND_POSY;
		rectBound = new Rectangle();
		normalRunAnim = new Animation(90);
		normalRunAnim.addFrame(Resource.getResouceImage("data/jugador4/main-character1.png"));
		normalRunAnim.addFrame(Resource.getResouceImage("data/jugador4/main-character2.png"));
		jumping = Resource.getResouceImage("data/jugador4/main-character3.png");
...
//		downRunAnim.addFrame(Resource.getResouceImage("data/main-character6.png"));
		deathImage = Resource.getResouceImage("data/jugador4/main-character4.png");
