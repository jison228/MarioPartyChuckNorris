...
public class EnemiesManager4 {
	...
	public EnemiesManager4(MainCharacter4 mainCharacter, int tier, int dificultadIA) {
		rand = new Random();
		cactus1 = Resource.getResouceImage("data/jugador4/cactus1.png");
		cactus2 = Resource.getResouceImage("data/jugador4/cactus2.png");
	...
	private Enemy createEnemy(int type) {
		type = 2;
		if (type % 2 == 0) {
			return new Cactus4(mainCharacter, 800, cactus1.getWidth() - 10, cactus1.getHeight() - 10, cactus1);
		} else {
			return new Cactus4(mainCharacter, 800, cactus2.getWidth() - 10, cactus2.getHeight() - 10, cactus2);
		}
	}
