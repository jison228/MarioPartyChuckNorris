...
public class MainCharacter {
	...
	private static final int LAND_POSY = 80;
	...
	public MainCharacter() {
		...
		normalRunAnim.addFrame(Resource.getResouceImage("data/jugador1/main-character1.png"));
		normalRunAnim.addFrame(Resource.getResouceImage("data/jugador1/main-character2.png"));
		jumping = Resource.getResouceImage("data/jugador1/main-character3.png");
...
//		downRunAnim.addFrame(Resource.getResouceImage("data/main-character6.png"));
		deathImage = Resource.getResouceImage("data/jugador1/main-character4.png");
