...
public class MainCharacter3 {

	private static final int LAND_POSY = 480;
	...
	public MainCharacter3() {
		posX = 50;
		posY = LAND_POSY;
		rectBound = new Rectangle();
		normalRunAnim = new Animation(90);
		normalRunAnim.addFrame(Resource.getResouceImage("data/jugador3/main-character1.png"));
		normalRunAnim.addFrame(Resource.getResouceImage("data/jugador3/main-character2.png"));
		jumping = Resource.getResouceImage("data/jugador3/main-character3.png");
...
//		downRunAnim.addFrame(Resource.getResouceImage("data/main-character6.png"));
		deathImage = Resource.getResouceImage("data/jugador3/main-character4.png");
