...
public class Land {
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		land1 = Resource.getResouceImage("data/jugador1/land1.png");
		land2 = Resource.getResouceImage("data/jugador1/land2.png");
		land3 = Resource.getResouceImage("data/jugador1/land3.png");
