...
public class Land2 {
	...
	public Land2(int width, MainCharacter2 mainCharacter) {
		this.mainCharacter = mainCharacter;
		land1 = Resource.getResouceImage("data/jugador2/land1.png");
		land2 = Resource.getResouceImage("data/jugador2/land2.png");
		land3 = Resource.getResouceImage("data/jugador2/land3.png");
