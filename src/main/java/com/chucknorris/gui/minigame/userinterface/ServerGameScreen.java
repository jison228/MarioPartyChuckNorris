...
public class ServerGameScreen extends JPanel implements Runnable, KeyListener {
	...
	public ServerGameScreen(Stack<String> listaGanadores) {
...
//			gameState = GAME_PLAYING_STATE; PARA QUE FUNCIONE EN SEGUNDO PLANO
	...
	static void saltosServer(Character character) {
